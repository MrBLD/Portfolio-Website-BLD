...
export const TracingBeam = ({ children, className, }: { children: React.ReactNode; className?: string; }) => {
  ...
  const y1 = useSpring(
    useTransform(
      scrollYProgress,
      [-0.02, 0.81], //Change the second value, increasing means going slow increasing the first means the starting point of the colored part
      [50, svgHeight]), {
    stiffness: 500,
    damping: 30,
  }
  ...
  return (
    <motion.div ref={ref} className={cn("relative w-fit sm:ml-48 h-full", className)}>
      <div className="absolute -left-4 md:-left-20 top-3">
        <motion.div transition={{ duration: 0.2, delay: 0.5, }}
